        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="http://127.0.0.1:8000">
                        ...
                        <img src="/img/logo.png" style="width: 50px; height: 25px;" alt="">
                        <h2 class="brand-text mb-0">MyLibrary</h2>
                    </a></li>
                    <li class="nav-item nav-toggle-true"><a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse"><i
                ...
                <div class="navbar-container content">
                    <div class="navbar-collapse" id="navbar-mobile">
                        <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                            ...
                            &ensp;
                            <a class="btn btn-primary" href="{{ route('menu') }}">Menu</a>
                        </div>
                        <ul class="nav navbar-nav float-right">
                            <li class="dropdown dropdown-user nav-item"><a
                                    ...
                                    <div class="user-nav d-sm-flex d-none"><span
                                            ...
                                            class="user-status">{{ Auth::user()->email }}</span></div><span><img class="round"
