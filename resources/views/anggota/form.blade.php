            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="nama" value="{{ isset($object) ? $object->nama : old('nama') }}" placeholder="Nama Anggota" autofocus required>
                      <div class="form-control-position">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                    <textarea name="alamat" class="form-control" placeholder="Alamat Anggota" required>{{ isset($object) ? $object->alamat : old('alamat') }}</textarea>
                      <div class="form-control-position">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="telepon" value="{{ isset($object) ? $object->telepon : old('telepon') }}" placeholder="Nomor Handphone Anggota" required>
                      <div class="form-control-position">
