            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="nama" value="<?php echo e(isset($object) ? $object->nama : old('nama')); ?>" placeholder="Nama Anggota" autofocus required>
                      <div class="form-control-position">
              ...
              <div class="col-12">
                <div class="form-group row">
                  <div class="col-md-2">
                    <span>Alamat Anggota</span>
                  </div>
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                    <textarea name="alamat" class="form-control" placeholder="Alamat Anggota" required><?php echo e(isset($object) ? $object->alamat : old('alamat')); ?></textarea>
                      <div class="form-control-position">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="telepon" value="<?php echo e(isset($object) ? $object->telepon : old('telepon')); ?>" placeholder="Nomor Handphone Anggota" required>
                      <div class="form-control-position">
...
<?php echo $__env->make('layouts.app', $viewData, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/Laravel/perpus/resources/views/anggota/form.blade.php ENDPATH**/ ?>