...
<div class="card">
    <div class="card-content">
        ...
        <?php if(isset($table['create'])): ?>
            <a href="<?php echo e($table['create']['url']); ?>" class="btn btn-primary"><span class="fa fa-plus"></span>
            <?php echo e($table['create']['label']); ?></a>
            <br>
            <?php endif; ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpuspbofix\perpus\resources\views/admin/user/index.blade.php ENDPATH**/ ?>