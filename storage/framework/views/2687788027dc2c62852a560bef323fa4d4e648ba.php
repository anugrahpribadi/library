            ...
            <div class="col-12">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="thn_terbit" value="<?php echo e(isset($object) ? $object->thn_terbit : old('thn_terbit')); ?>" placeholder="Tahun terbit" required>
                      <div class="form-control-position">
              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="jumlah_buku" value="<?php echo e(isset($object) ? $object->jumlah_buku : old('jumlah_buku')); ?>" required>
                      <div class="form-control-position">
                        <i class="feather icon-calendar"></i>
                      </div>
                    </div>
              ...
              <!-- <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative has-icon-left">
                      <input type="text" class="form-control" name="status" value="<?php echo e(isset($object) ? $object->status : old('status')); ?>" placeholder="Status">
                      <div class="form-control-position">
                  ...
                  <div class="col-md-10">
                    <div class="position-relative">
                      <select class="form-control select2" id="status" name="status" required>
                        ...
                        <?php $__currentLoopData = config('general.status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(isset($object) && $object->status == $key ? 'selected' : ''); ?>><?php echo e($item['label']); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
...
<?php echo $__env->make('layouts.app', $viewData, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/Laravel/perpus/resources/views/Book/form.blade.php ENDPATH**/ ?>