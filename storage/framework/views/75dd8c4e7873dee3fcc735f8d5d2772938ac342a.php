        ...
        <div class="col-md-3" style="max-width: 50rem;">
          <div class="card mb-3 shadow-sm">
            <br>
              ...
              <hr>
            <div class="card-body">
              <a href="/detailbuku/<?php echo e($b->id); ?>">
                <h4><b><?php echo e($b->judul); ?></b></h4>
                <h6>By : <?php echo e($b->penulis); ?></h6>
                <h6><?php echo e($b->penerbit); ?></h6>
                <h6><?php echo e($b->kategori_id->nama); ?></h6>
              </a>
              <?php if(Auth::guest()): ?>
              <p><a href="<?php echo e(route('login')); ?>" class="btn btn-primary">Detail</a></p>
              <?php else: ?>
...
<?php echo $__env->make('layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpuspbofix\perpus\resources\views/menu.blade.php ENDPATH**/ ?>