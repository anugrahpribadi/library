...
<div class="card">
    <div class="card-content">
        <div class="card-body">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create transaksi')): ?>
            ...
            <?php if(auth()->user()->name == "Admin"): ?>
                <a href="<?php echo e(route('cetak-transaksi')); ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Cetak</a>
            <?php endif; ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\libraryc\resources\views/transaksi/index.blade.php ENDPATH**/ ?>