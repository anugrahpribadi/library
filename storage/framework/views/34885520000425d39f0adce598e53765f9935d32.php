...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-white bg-white">
        ...
        <a class="nav-link btn btn-primary" href="<?php echo e(route('home')); ?>" style="pointer-events: none;cursor: default;">Dashboard</a>
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary" href="<?php echo e(route('histori')); ?>">Histori</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
...
</body><?php /**PATH C:\xampp\htdocs\perpuspbofix\perpus\resources\views/layouts/nav.blade.php ENDPATH**/ ?>