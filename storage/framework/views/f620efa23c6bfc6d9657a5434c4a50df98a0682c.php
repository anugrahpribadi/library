...
<div class="card">
    <div class="card-content">
        <div class="card-body">
        <a href="<?php echo e(route('cetak-peminjaman')); ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Cetak</a>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\resources\views/pinjam.blade.php ENDPATH**/ ?>